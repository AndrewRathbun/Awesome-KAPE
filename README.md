...
- Kroll Blog - KAPE Quarterly Updates
  ...
  - [KAPE Quarterly Update – Q4 2021](https://www.kroll.com/en/insights/publications/cyber/kape-quarterly-update-q4-2021)
  - [KAPE Quarterly Update - Q1 2022](https://www.kroll.com/en/insights/publications/cyber/kape-quarterly-update-q1-2022)
  - [KAPE Quarterly Update - Q2 2022](https://www.kroll.com/en/insights/publications/cyber/kape-quarterly-update-q2-2022)
...
- [kape_info.py](https://gist.github.com/Beercow/5e13282541f79580405f96364baca8d5)
...
- [Computer Forensics Tools | Kroll Artifact Parser and Extractor | TryHackMe KAPE](https://youtu.be/AcYNcZurEOA)
...
| 2022-12-22 | 1.3.0.0 | - Change from nlog to Serilog (much nicer console output)<br> - New module variables for command lines: `%d%`, `%guid%`, and `%sourceDirectoryBase%`<br> - General tweaks and fixes<br> - Nuget package updates<br> - Updated EZTools binaries<br> - Sync'ed Targets and Modules |
