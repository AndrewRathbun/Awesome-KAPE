...
| 2021-11-16 | 1.1.0.1 | Fix issue with SFTP verification when using `-scd`and the directory already existed<br>-Updated Trgets and Mdules<br>- Nuget and control updates |
